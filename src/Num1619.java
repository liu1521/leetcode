...
public class Num1619 {
    ...
    public static void main(String[] args) {
        Num1619 num1619 = new Num1619();

        int[] arr1 = {1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 3};
        Assert.check(Math.abs(num1619.trimMean(arr1) - 2.0D) <= Math.pow(10, -5));

        int[] arr2 = {6,2,7,5,1,2,0,3,10,2,5,0,5,5,0,8,7,6,8,0};
        Assert.check(Math.abs(num1619.trimMean(arr2) - 4.0D) <= Math.pow(10, -5));

        int[] arr3 = {6,0,7,0,7,5,7,8,3,4,0,7,8,1,6,8,1,1,2,4,8,1,9,5,4,3,8,5,10,8,6,6,1,0,6,10,8,2,3,4};
        Assert.check(Math.abs(num1619.trimMean(arr3) - 4.77778D) <= Math.pow(10, -5));
        ...
        Assert.check(Math.abs(num1619.trimMean(arr4) - 5.27778D) <= Math.pow(10, -5));
        ...
        Assert.check(Math.abs(num1619.trimMean(arr5) - 5.29167D) <= Math.pow(10, -5));
    }
